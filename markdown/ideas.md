...
**2025-08-02**：所以我建议，以后一切专业的毕业论文（设计）通通以视频形式发表，极度突出研究成果的视听呈现。视频的内容可以包括调查研究过程（如文献调查、实验、试验、建模、观测、编码、采访、研讨）的录音录像、论证过程的亲自讲解、重要论点的可视化展示（图表、动画等）。如果不具备像3B1B等up主那样通过一个视频把道理讲清楚的能力，不能授予学位。
...
2025-07-05：大模型的价值不在于它能生成“新知识”，而在于它能生成“我不知道的知识”。对于大多数人大多数情况，这已经很好了。**将知识转化为“我知道我知道的知识”，就是信息检索的目的。**既然AI只能提供“我不知道的知识”，所以唯一的对策就是不断增加“我知道我知道的知识”，主动地从环境中获取信息，这种自我驱动的学习就是强者思维。请扪心自问，您和AI，谁才是强者。
...
2023-03-24：正在排查过往言论中使用成语的情况。我个人认为，音视频编码的核心技术在于编码表，那个东西反映出信源内禀的统计特性，是要耗费真金白银去做调查研究才能得到的一手知识。而自然语言中的成语，或者类似的凝练表述如典故、段子、模因、比喻、格言、名句，起到了某种压缩编码的作用。脑子里的编码表越庞大，表达的质量和效率就越高。
...
深入挖潜，专心打磨，这是存量时代高质量发展的应有之义。我们成天把“高质量发展”挂在嘴边，有谁真正理解了？心态和观念同样要“高质量发展”。破除贪多求全、大干快上的旧观念，树立精益求精、永续精进的新思维。板凳坐得十年冷，同时要给予“冷板凳”以充分的利益和体面。
