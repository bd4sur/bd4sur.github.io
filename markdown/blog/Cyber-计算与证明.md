...
> 引用豆瓣“猫大仙”的观点：近几年开启我思想形成的是柄谷行人《作为隐喻的建筑》，初不觉异，但其中的思想几乎贯穿了我对哲学的绝大多数思考。而柄谷所提到的哥德尔证明，我一直认为是过难的数学，迟迟没有接触。如今终于鼓足勇气读完了。数学一直潜在认为自己能豁免于亚里士多德的“无限后退”与休谟的“怀疑论”，高斯等人对古典定理的证明使这台“永动机”开始摇晃，希尔伯特、怀特海与罗素的体系重构，让罗素感叹数学已经成为一种有别于算学的东西(大意)。美丽的哥德尔PM系统及其无法一致的最终判词出现的一刻，是真正震撼人心的。

------

2023-11-07

前段时间研读哥德尔不完全性定理证明过程的另一个重要收获是，领略了“前沿”数学证明的规模和面貌。

- 解决一个问题，首要的是对问题作形式化。形式化得好，就成功了一半。比如说数理逻辑里面的“完全性”概念，为了形式定义这个概念，花了半本教材的篇幅。
- 证明的进路，曲径通幽。形式化的问题，简短而高度凝练，是因为其中的概念被极大地压缩编码了。对概念进行解码，解码为更基础的原子概念，直至不言自明的基本概念，此时已经是散落在地上的一大堆积木了。随后就是寻找一些可能的方法，将大量的积木重新组合成一个精巧的结构，最终赋予它一个简短而通俗的名字。

------

2024-11-14：我总觉得数理逻辑的一个根本任务就是搞清楚 |-、|=和它们两个的区别，为了完成这个任务，造了一大堆轮子。
