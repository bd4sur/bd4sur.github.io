...
DFM可生产性设计，出处不详：我的外贸公司接到一个OEM机加图纸，跟工厂合作报完价确认完试件，由于订单量大，工厂决定购买一批新数控设备来批量生产，于是内部工艺流程确认工作和新设备的采购工作同时进行。几轮设备报价审核结束后，大老板在两台性能接近的设备型号中拍板选择了较便宜的一个型号，两者区别是较便宜的这个型号的刀库较小，少两个刀具位，但是根据做试件的经验，刚好够用。批量生产开始后，发现当初做试件时忽略了图纸上的一个倒角要求，客户也没提。但是批量生产后客户以图纸为证据要求产品符合图纸。由于新设备没有多余的刀具位，不得不在工艺流程中额外加入一道专门倒角的工步，导致利润下降15%。工艺流程设计要以产品开发，产品管理，质量管理，生产计划的inputs为基础来开展。产品设计的改变哪怕很微小，也可能造成成本的大幅增加。现在企业招聘设计人员时很注重DFM-为可生产性而设计。

## 老化

以前铸造的机床车身要求在自然环境里风吹日晒三年。三年以后在进行表面处理。和下一步的安装工作。现在铸造机床车身刚出制造车间温度还没降下来就要求表面处理和安装。
...
![[来源](https://www.scienceforums.net/uploads/monthly_2017_10/image.png.abd636b528935249ec44b2b7210391f5.png)](./image/K/delta-v.png)
