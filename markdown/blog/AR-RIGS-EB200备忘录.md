...
作为监测接收机，EB200主要提供三大功能，一是**信号接收与解调**，二是**信号扫描搜索**，三是**电平测量**。基于这三大功能，可以遂行多种无线电监测任务，包括：监测已知频率频段全景；监测合作信号源的工作状况；监测非合作信号；扫描搜索非预期信号（如干扰信号）；发现并寻找隐藏的信号源（比如窃听器、微型对讲机和无线针孔摄像头）；通过单通道相关干涉法测定来波方向；使用高指向性天线，通过车载或者徒步方式进行抵近测向和定位；使用已标定的标准天线进行场强测量；组建无线电监测台网进行覆盖分析和远程监测，等等。
...
EB200原配电池是两块NJ1020镍氢电池组，由10节17670镍氢电池串联组成，电压12V，内置保护板，可通过SMBus协议与电池盒和EB200主机通信，交换充放电状态、剩余电量等信息。两块电池并非同时放电或者充电，而是一个接一个地工作。电池充电必须输入20~22V直流电压。EB200BP电池盒所使用的核心芯片是LT1511CSW以及LTC1438。

镍氢电池能量密度比锂离子电池低很多，且具有记忆效应，但是安全性比较好，电池自身在原理上几乎不可能起火，也不会爆炸。据文献（陈喜红. **R&S EB200 便携式无线电测向仪的电池改造**[J]. 中国无线电, 2009(4):2.）报道，EB200原配镍氢电池，起初最长续航时间为3～4小时，在不到一年时间里，充电后只能够使用1～2小时甚至几十分钟。而更换锂离子电池组之后，EB200显示电池组使用时间可达740～945分钟，实际使用时间达16小时。

接口朝下，左侧是1号槽位（系统Bat2），右侧是2号槽位（系统Bat1）

- 1号电池1号槽位：
- 1号电池2号槽位：
- 2号电池1号槽位：Bat1 Not equip / Bat2 Charging 1%
- 2号电池2号槽位：Bat1 Not in use → Charging 11% / Bat2 Not equip
...
原配附件包括两副天线，一副是UHF鞭状天线，另一副是螺旋形软天线。产品文档中并未提到这两副天线及其参数，用NanoVNA测量螺旋软天线，发现谐振点似乎被设置在70MHz附近，带宽很窄，不清楚是什么用途。
...
天线：对于移动测向任务来说，一副好的天线比接收机更重要。罗德施瓦茨提供了配套的手持高指向性天线，并提供方向图、增益、天线系数等技术资料，因此既可以用于无线电测向，也可以用于场强测量。当然，价格也是极为昂贵的。
