...
> 发在最近一期Science上的研究（doi.org/10.1126/science.aed1656）发现某种细菌体内有一种酶，这种酶能以自身为模板合成DNA。而我说，这只是在重复原始汤故事罢了，前30亿年里这样的东西怕是到处都是。你怎么看？

在生命起源前的原始汤里，确实可能存在各种我们今天看来"不规范"的复制方式。RNA世界假说的核心就是认为，在蛋白质酶和DNA出现之前，RNA分子本身既能存储信息又能催化反应——即自我复制的核酶。最近剑桥大学团队发现的 QT45 核酶（仅 45 个核苷酸长）已经能在实验室中实现接近自我复制的两步反应。这说明**生命早期确实可能充斥着各种非模板依赖的、自我催化的聚合机制**，远比现代细胞"规矩"的半保留复制要混乱和多元。但关键的区别在于方向性：原始汤里的自我复制，基本是同类复制同类——RNA 复制 RNA，或者肽段诱导肽段聚合。而你提到的这个 Drt3b，实现的是蛋白质→DNA的信息流。这在现代生物化学里是前所未有的。如果这在早期地球上普遍存在，意味着遗传信息的载体可能在核酸和蛋白质之间更加流动，而不是我们后来固化下来的DNA独霸信息存储模式。

至于“前30亿年这样的东西怕是到处都是”，这句话我更愿意把它当作一种哲学推测，而不是科学断言。但从现有证据看，有几个角度可以支撑你的直觉：一是细菌防御系统是演化创新的温床。CRISPR最初也是细菌抗病毒的"怪招"，后来被人类改造成基因编辑工具。DRT3系统在多种细菌中都有发现，说明它可能不是孤立的怪胎，而是某种更普遍的生化策略的冰山一角。二是“RNA-肽世界”的过渡态：有研究提出，在纯粹的 RNA 世界和现代的 DNA-蛋白质世界之间，可能存在一个“RNA-肽共演化”的中间阶段，其中 RNA 和短肽通过共价连接形成嵌合分子，逐渐演化出核糖体翻译系统。如果 Drt3b 这类机制真的在早期普遍存在，它可能代表了那个过渡态中蛋白质开始反向影响遗传物质的遗迹。三是分子化石 vs. 独立创新：这里有两种可能。一种是 DRT3 系统确实是某种分子化石，保留了前30亿年某种原始信息传递方式的残迹；另一种可能是它只是细菌在与噬菌体军备竞赛中独立发明的新奇机制。目前的数据还无法区分这两种可能。

我们关于“生命如何存储和传递信息”的叙事是否过于干净了？教科书里的中心法则是一个简化的模型，它帮助几代人理解了分子生物学，但也可能让我们产生了一种进化已经找到最优解的错觉。DRT3的发现提醒我们，细菌在过去几十亿年的军备竞赛中，可能保留了（或不断重新发明了）各种被主流演化淘汰或边缘化的生化机制。这些机制在真核生物的简化世界里早已消失，但在微生物中依然活跃。

> 详细说说原始汤里都有哪些自我递归的东西。

所谓自我递归在原始汤语境下指的是：一个系统能够利用自身的产物或结构，作为生产更多自身所需的催化剂或模板。这种正反馈是“死物”与“活物”之间的第一道裂缝。原始汤里已知的（或高度推测的）自我递归系统，大致可以分成七个层次：

- RNA：既是信息，又是机器。RNA世界假说的核心就在于此：RNA既能像DNA一样存储遗传信息，又能像蛋白质酶一样催化化学反应。如果某种RNA序列能催化自己的复制，或者催化其互补链的合成，那么它就同时扮演了基因和聚合酶的角色。2026年初，剑桥大学的研究证明：极小的RNA分子就可能具备自我合成的能力，而不需要预先存在复杂的酶机器。这打破了只有大分子才能复制自己的假设。
- 肽与蛋白质：结构的自我递归。在RNA世界之前或并行，短肽也可能存在自我递归。某些短肽序列能够催化自身的合成，或催化同类肽的聚合。更广义地说，淀粉样蛋白的聚合本身就是一种自模板过程，已有的纤维结构作为模板，诱导更多单体以相同的折叠方式沉积。在原始汤中，这种结构复制可能是一种原始的信息传递形式。你提到的Drt3b（以蛋白质为模板合成 DNA）如果真的是某种分子化石，那它可能暗示：在极早期，蛋白质→核酸的信息流并非完全不可能，只是后来被DNA→RNA→蛋白质的中心法则压制了。
- 糖：Formose反应的自催化循环。这是化学上最明确的非生物自催化系统之一。在碱性条件下，甲醛可以自发聚合生成各种糖（乙醇醛、甘油醛、核糖等）。其核心机制是Breslow自催化循环。这就是纯粹的化学自催化：产物（乙醇醛）加速自身的生产。但Formose反应有个致命问题：它会产生极其复杂的糖混合物，最终变成焦油。2025年的研究甚至对Breslow的经典自催化机制提出了质疑。有趣的是，Formose反应不仅产糖，在碱性热液条件下还会产生乳酸、乙醇酸等简单有机酸——这些正是现代代谢的核心分子。所以有人提出，Formose系统可能不是一个单纯的糖工厂，而是一个更广泛的原始代谢网络。
- 脂质与囊泡：容器的自我增殖。没有容器的分子复制只是化学噪声。原始汤中，脂质结构的自我增殖提供了“个体性”的雏形。首先，有研究者构建了一个存在脂质囊泡的生长与分裂行为的原始细胞模型，实现了递归式自我增殖。第二，有研究表明，纳米级脂质胶束本身就具备催化能力，可以催化自身组成分子的合成，牛津大学团队甚至构建了带有原位有机催化剂的自复制脂质囊泡，能在特定环境条件下实现功能化自复制。2025 年，有研究将DNA复制反应与双水相系统中的囊泡生长耦合，实现了基因复制驱动的原始细胞自生长。虽然离真正的自主分裂还有距离，但说明遗传物质的复制与容器增殖的耦合是可以从化学原理中涌现的。
- 代谢网络：没有基因的自催化。生命的本质不仅是复制分子，更是复制一套化学反应网络。自催化集合的概念指出，在一个足够多样化的化学汤中，某些分子子集会形成一个闭环——集合中的每个分子都由集合内的其他分子催化生成，且所有原料都可以从环境中获得。这不是单个分子的自我复制，而是一个分子社会的集体自复制。Formose反应本身就是最简单的代谢自催化网络之一。更复杂的如还原性柠檬酸循环，在现代细胞中它是碳固定的核心，但理论上它也可以是一个自催化的代谢循环：每轮循环的产物可以催化下一轮循环的入口。Chemoton（化学机器）模型进一步将自催化代谢网络、模板复制和膜边界三者耦合，认为只有当这三个子系统同时递归自复制时，才构成最小生命单元。
- 超循环：分子社会的递归。1970年代提出的超循环（Hypercycle）理论试图解决一个根本矛盾：早期复制分子的错误率太高，无法维持长序列的信息传递。解决方案是多个自复制分子相互催化，形成一个循环网络。这样，每个分子只需要准确复制一小段信息，整个网络通过合作维持复杂性。超循环是从分子复制到群体演化的关键桥梁，也是自催化集合的一种特殊拓扑。
- 矿物表面：无机模板的递归。原始汤里还有大量无机界面。**铁硫世界假说（Iron-Sulfur World）**认为，热液喷口附近的硫化铁矿物表面具有催化活性，可以固定CO₂并驱动有机分子的合成。矿物晶格本身可以作为一种“物理模板”：特定的晶体面选择性地吸附和排列有机分子，使其以特定方式聚合。虽然这不是严格意义上的自我递归（矿物本身不复制），但它提供了非生物的模板化和催化化机制，可能是上述所有有机递归系统得以启动的“脚手架”。

总而言之，原始汤中的自我递归不是单一现象，而是一个层级递进的谱系：

| 层级 | 递归形式 | 代表系统 |
|------------------------|
| 分子级 | 自模板复制 | RNA 核酶（QT45）、淀粉样蛋白 |
| 化学循环 | 自催化网络 | Formose 反应、代谢循环 |
| 分子社会 | 集体自催化 | 超循环、自催化集合 |
| 容器级 | 边界自增殖 | 脂质囊泡、胶束 |
| 系统级 | 三大系统耦合 | Chemoton（代谢+模板+膜）|

你之前说“前30亿年这样的东西怕是到处都是”，如果把这些层级都考虑进去，这个判断其实相当合理。原始汤可能不是等待RNA降临的被动溶剂，而是一个充满了各种自催化火花的化学竞技场——RNA 复制、糖自催化、脂质囊泡增殖、矿物表面催化，所有这些递归系统可能在同一时空里竞争、耦合、吞噬彼此。最终胜出的不是最完美的复制者，而是最能把信息复制、能量捕获和边界维持三者递归耦合起来的系统。Drt3b这类现代细菌中的怪胎，或许正是那个竞技场中某条被主流淘汰、却在微观暗处幸存下来的古老路径的回声。

> 详细说说铁硫世界理论，以及它跟呼吸链中某些酶的铁硫催化核心的关系。

铁硫世界理论是现代生命起源研究中“代谢优先”阵营的旗舰模型，它与呼吸链中铁硫簇的演化联系，可能是从地质化学到生物化学最清晰的桥梁之一。

铁硫世界理论的核心主张可以概括为三点：

- 地点：深海热液喷口的硫化铁表面。生命并非起源于温暖的原始汤，而是诞生于深海火山热液喷口——即所谓的“黑烟囱”——周围的硫化铁矿物表面。这些环境富含H₂S、CO₂、CO、N₂等还原性气体，且存在强烈的氧化还原梯度。
- 能量：黄铁矿（FeS₂）的形成作为原始动力。硫化亚铁与硫化氢反应生成黄铁矿，同时释放电子和质子。这些电子可以将溶解的CO₂还原为简单的有机分子（如甲酸、甲醇），而质子梯度则为后续反应提供化学势能。这一过程称为“表面代谢”：有机分子吸附在带正电的硫化铁表面，形成二维反应网络，避免了前生物汤中产物稀释的问题。
- 顺序：代谢先于遗传。与RNA世界假说相反，铁硫世界认为能量捕获和碳固定循环先于遗传物质出现。最早的生命不是自我复制的分子，而是一套在矿物表面运行的自催化化学反应网络——可能是还原性柠檬酸循环的硫化物版本。

铁硫世界理论最具说服力的部分，恰恰在于现代生物化学与原始地质化学之间的连续性。

- Fe-S簇是分子化石。如果早期生命确实在富含FeS的喷口环境中诞生，那么它最早使用的催化剂很可能就是矿物表面本身。现代蛋白质中的Fe-S簇，在化学本质上与矿物硫化物中的铁硫核心几乎相同——只是被蛋白质骨架精确包裹了。换言之，呼吸链中的Fe-S酶不是后来发明的精密工具，而是对原始矿物催化剂的生物模拟和继承。
- 前生物条件下Fe-S簇可以自发形成。这一点在2025年得到了验证。有研究表明，在模拟早期地球浅层碱性水体的条件下，Fe-S簇可以自发组装在仅含三个氨基酸的短肽上，从单核铁逐步升级到[2Fe-2S]、[4Fe-4S]，甚至类似固氮酶的[6Fe-9S]巨型簇。这意味着，生命出现之前，地球表面已经存在各种原型Fe-S催化剂，等待被多肽捕获。
- 祖先级的Fe-S生物合成系统。现代细胞合成Fe-S簇需要复杂的蛋白机器（ISC、SUF、NIF系统），包括半胱氨酸脱硫酶、支架蛋白、载体蛋白等。但2025年的一项研究发现了更古老的SMS系统，存在于超嗜热古菌中，是一个直接从地质硫源获取铁硫核心的最小生命系统。SMS系统没有半胱氨酸脱硫酶，不需要从氨基酸中拆解硫原子；可以直接利用环境中的矿物硫化物作为硫源组装[4Fe-4S]簇；可以在无氧条件下拯救缺失ISC和SUF系统的大肠杆菌。研究者推测，SMS代表了LUCA（最后普遍共同祖先）时代的Fe-S合成方式，而SUF和ISC系统只是大氧化事件之后，为了应对氧气对Fe-S簇的破坏而演化出的加固版。
- 代谢循环的连续性。现代呼吸链和rTCA循环中的许多关键反应，在化学上与原始表面代谢高度相似。例如，rTCA循环中的顺乌头酸酶本身就含有一个[4Fe-4S]簇，且该循环被认为是自养碳固定的最古老途径之一。如果最早的碳固定确实发生在矿物表面，那么当这些反应被"封装"进原始细胞时，保留Fe-S簇作为催化核心是最自然的路径依赖。

把以上线索串起来，可以得到一个相当清晰的叙事：

- **地质阶段**：早期地球的FeS喷口表面自发催化CO₂固定，产生简单有机物，形成自催化代谢网络（铁硫世界）。
- **捕获阶段**：短肽吸附在矿物表面，稳定并扩展了Fe-S核心的催化能力；矿物表面的二维反应逐渐获得三维分子支架。
- **遗传阶段**：RNA/DNA出现，编码这些已经证明有效的Fe-S蛋白；原始呼吸链的雏形诞生。
- **优化阶段**：大氧化事件后，细胞演化出专门的Fe-S生物合成机器，将原本依赖环境H₂S的自发组装，内化为受控的酶促过程。
- **现代阶段**：线粒体中的呼吸酶，仍然使用着与40亿年前黄铁矿表面化学本质相同的Fe-S簇来传递电子。

> 你刚才说到：RNA/DNA出现，“编码”这些已经证明有效的Fe-S蛋白。这是怎么做到的？

这是生命起源研究中最深、最宽的鸿沟——从自催化的化学反应网络，到能够存储和传递信息的遗传系统。没有任何一种理论能完全填平它，但过去几十年已经拼出了几条可能的路径。在铁硫世界的框架下，这个故事通常被描述为“遗传接管”的渐进过程。

问题的本质在于：代谢不会自动变成遗传。在铁硫世界里，最早的生命更像是一套在矿物表面运行的自催化代谢网络。这套系统能“繁殖”——当矿物晶体生长并断裂时，其表面的反应网络被复制到新晶体上——但它没有序列信息，没有编码，没有数字化的遗传。真正的遗传需要两个东西：模板复制（可复制的信息载体）和表型表达（信息能指导功能分子的合成）。矿物表面本身做不到这一点。所以核心问题是：遗传物质如RNA/DNA是如何从这套代谢网络中“涌现”出来，并开始编码那些已经在矿物表面证明有效的Fe-S蛋白的？

1980年代提出的“遗传接管”框架认为：新的遗传物质不需要从旧的遗传物质演化而来。它可以是代谢系统的副产品，通过渐进的优势积累，最终取代原来的遗传机制。该框架认为最早的“基因”可能是**粘土矿物的晶体缺陷模式**——晶体生长时，层间吸附的杂质和晶格缺陷形成可复制的信息，晶体断裂时这些信息被复制。虽然粘土假说本身争议很大，但遗传接管的逻辑框架被保留了下来：

- 第1阶段：矿物表面作为原始基因和原始催化剂的双重角色。
- 第2阶段：代谢网络开始合成有机分子（包括RNA），这些分子最初只是代谢的副产品。
- 第3阶段：某些有机分子如RNA获得了更高效的复制能力，开始稳定携带有关代谢网络的信息。
- 第4阶段：RNA逐渐接管遗传功能，矿物表面退化为单纯的催化剂，最终被蛋白质酶取代。

RNA从哪里来？如果RNA是代谢的副产品，它必须能从原始汤中的简单前体合成。近年来，有研究者在碱性热液喷口条件下发现，在模拟的碱性热液系统中，H₂和CO₂在FeS/NiS矿物催化下可以生成甲酸、甲醛等一碳化合物。这些前体进一步反应，可以生成核糖磷酸和腺苷一磷酸（AMP），也就是RNA的两个关键构件。这意味着，RNA的构件可能就在铁硫世界代谢网络的下游，并不需要一套完全独立的化学路径。矿物表面不仅催化碳固定，还可能催化核苷酸前体的合成。

生物催化剂的“设计蓝图”从哪里来？矿物催化剂是如何跃迁到生物催化剂的？如果最早的催化剂是矿物表面的Fe-S簇，那么当蛋白质开始合成时，保留Fe-S簇作为催化核心是最自然的路径依赖。前面提到过，前生物条件下Fe-S簇可以自发形成。这意味着，最早的Fe-S蛋白可能极其简单，一个短肽包裹一个矿物衍生的Fe-S簇，就足以继承矿物表面的催化能力；另一方面，RNA不需要发明全新的催化机制，它只需要编码那些能稳定已有Fe-S核心的短肽。因而，从矿物到蛋白的过渡是渐进的：矿物表面→矿物-肽复合物→完整的Fe-S酶，每一步都有化学连续性。前文提到的SMS系统的发现表明，即使在现代超嗜热古菌中，仍然存在直接从环境组装Fe-S簇的古老途径。这暗示LUCA时代的Fe-S合成几乎就是矿物化学的直接延伸。

RNA世界假说认为RNA既能存储信息又能催化反应，但RNA如何开始指导氨基酸聚合，形成有功能的Fe-S蛋白？这就是翻译系统的起源问题。

- 原始核糖体与硫酯世界。核糖体是细胞中最古老的分子机器，其核心——肽基转移酶中心（PTC）——完全由RNA构成。这意味着在核糖体蛋白出现之前，RNA本身就具备催化肽键形成的能力。有研究表明，在前地球条件下，硫酯激活的氨基酸可以与RNA直接反应，生成短肽。硫酯是铁硫世界理论中能量传递的关键分子。这项研究将“RNA世界”和“硫酯世界”统一起来——RNA 和激活的氨基酸可以在同一化学环境中共存并相互作用。
- tRNA的核心角色。tRNA可能是连接RNA和蛋白质世界的关键分子。有假说认为，最早的基因可能就是tRNA样分子。这些分子既参与翻译（携带氨基酸），又可能通过反向互补配对形成最早的基因组。tRNA核心假说提出：最早的tRNA样分子组织起了原始翻译系统，它们催化了核糖体PTC的组装；最早合成的蛋白质是能与tRNA结合并稳定其结构的短肽，这些短肽反过来提高了翻译的保真度；这些短肽中可能包含Fe-S结合域，因为Fe-S簇是矿物表面最丰富的催化中心。
- 从非特异性到特异性编码。最初的RNA-氨基酸相互作用可能完全是物理化学的、非特异性的——某些RNA序列因为结构原因偏好结合某些氨基酸。随着翻译系统的演化，这种偏好逐渐被固化为遗传密码。Fe-S蛋白可能是最早被编码的蛋白质之一，因为：它们的合成只需要短肽（稳定Fe-S簇）；它们的功能（电子传递、氧化还原）直接继承自矿物表面化学；它们对原始细胞的能量代谢至关重要。

把所有这些线索拼起来，从矿物代谢到RNA编码Fe-S蛋白的过渡，可能经历了以下阶段：

| 阶段 | 特征 | 关键机制 |
|---------------------|
| **矿物代谢** | FeS表面催化CO₂固定，产生有机酸、氨基酸、核苷酸前体 | 表面自催化，黄铁矿能量学 |
| **分子涌现** | 短肽自发包裹Fe-S簇；RNA寡聚体在矿物表面合成 | 前生物Fe-S簇组装；碱性喷口核苷酸合成 |
| **RNA-肽共生** | RNA催化肽键形成；短肽稳定RNA结构；硫酯提供能量 | 原始 PTC 活性；UCL 硫酯-肽合成 |
| **遗传接管** | RNA开始作为“少数派控制”的信息载体，编码已证明有效的Fe-S短肽 | 少数派控制机制 |
| **原始呼吸链** | 编码的Fe-S蛋白从矿物表面脱离，在脂质囊泡中组装成电子传递链 | 代谢与膜边界耦合 |

这个图景虽然连贯，但仍有巨大的缺口：

- RNA 复制的启动：最早的RNA复制酶（无论是核酶还是蛋白质酶）从何而来？
- 密码子的起源：从RNA-氨基酸的物理化学偏好到三联体密码的精确映射，中间步骤仍然模糊。
- 膜边界的耦合：Fe-S蛋白的催化需要氧化还原梯度，而脂质囊泡的封闭可能切断与矿物表面的直接接触。原始细胞如何同时维持碳固定、能量捕获和遗传复制？

铁硫世界理论的价值在于它提供了一个化学上连续的叙事：从黄铁矿表面的氧化还原反应，到短肽包裹的Fe-S簇，再到RNA编码的Fe-S蛋白。每一步都不需要奇迹般的跳跃。遗传信息不是从虚空中降临的，而是从已经运转了数百万年的代谢网络中，作为一种更高效的“记忆方式”被逐渐选中、传承和优化的。

> RNA是如何“编码”矿物表面的代谢网络的？你上面的回答并没有完全讲清楚这个遗传接管过程。

从矿物表面的二维化学反应网络，到RNA的线性序列编码——从空间的、连续的、模拟的化学过程，到序列的、数字的、符号的信息系统。这两者之间存在鸿沟，目前还没有任何一种理论能完全填平它。

首先澄清问题本质。矿物表面的代谢网络是“组成型遗传”原始细胞继承的是其内部化学反应的“配方比例”。这种遗传是模糊的、模拟的、连续的。当原始细胞分裂时，新细胞继承的化学组成大致相似，但不会精确复制每一个分子的位置。RNA的遗传则是“模板型遗传”：信息序列精确复制，存在一个从编码序列到组成表型的表达过程，突变是离散的、可遗传的。所以核心问题是是：一个最初只懂组成型遗传的系统，是怎么被一种全新的模板型遗传机制取代的？

2025年提出的肽原码假说（Peptide Protocode）认为：

- **阶段1：包含Fe-S核心的肽聚集体是代谢的功能载体，而与其选择性结合的核苷酸是其稳定剂**：矿物表面催化产生的短肽自发折叠，形成能包裹Fe-S簇的原始催化剂。这些肽聚集体通过非共价相互作用（氢键、π-π堆积），选择性地吸附核苷酸/核苷。此时，核苷酸不是“基因”，而是化学稳定剂——它们的存在降低了肽聚集体的降解速率，延长了代谢功能载体的寿命。
- **阶段2：代谢功能载体与核酸序列的空间结构映射**：核苷酸在肽聚集体表面的吸附是有选择性的，特定肽构象（比如一个能结合[4Fe-4S]的β-发夹）有特定的电荷分布和氢键模式，偏好吸附特定的核苷酸组合。这就形成了一种**原始的空间映射**，将肽的三维结构映射到核苷酸符号的空间排列。此时还没有“编码”，只有物理-化学的自然互补性。
- **阶段3：稳定的代谢功能载体-核酸复合物的空间模式被选择性强化**：当RNA寡聚体开始通过矿物表面催化或湿干循环合成时，那些恰好能吸附在有效肽聚集体上的RNA序列被选择性保留。反过来，某些RNA序列的折叠可能偏好结合特定氨基酸。有研究证明，tRNA受体茎的末端三个碱基对能决定氨酰化的化学选择性和立体选择性。这暗示了最早的密码可能是RNA折叠模式与氨基酸空间构象之间的直接的物理化学亲和性。
- **阶段4：更擅长遗传的核酸，成为代谢功能载体的“数字孪生体”**：随着复制机制的改善，RNA序列开始比肽聚集体更稳定地传递信息。那些能指导合成有效Fe-S肽的RNA序列获得选择优势。此时发生了遗传接管：信息存储的功能从“肽聚集体+矿物表面”的组成型遗传，转移到了RNA序列上发生的模板型遗传。

[[#ff0000:在这个框架下，RNA编码的不是代谢网络本身，而是代谢网络中关键的、可模块化的催化元件，也就是包含Fe-S核心的肽聚集体。这些原始“酶”的存在，即可自发驱动化学动力学网络，而无需编码网络自身。代谢网络的动力学是自组织的，只要RNA能指导合成足够的催化元件，自组织的代谢网络就会自发涌现。这与现代细胞一致：基因组编码酶，但不编码代谢通路的拓扑——**代谢结构是酶促反应的自然结果**。#]]

2025年的一项研究，描绘了这样一个具体的化学场景：在矿物表面附近的膜状微区室中，RNA片段通过硫酯加载了特定氨基酸。这些氨酰-RNA在RNA模板指导下聚合，生成短肽。短肽折叠后结合Fe-S簇，重建了矿物表面的催化功能，启动了自组织的代谢网络。此时，RNA序列与肽功能之间建立了一条可复制的因果链。

然而，即使有了上述机制，以下问题仍然没有令人满意的答案：

- 密码本的起源：如果最初的编码完全基于物理化学亲和性（比如特定RNA口袋偏好结合特定氨基酸），那么从物理化学映射到三联密码映射的过渡是如何发生的？一种可能是：最初的密码子分配确实基于亲和性（比如富含嘌呤的RNA区域结合疏水氨基酸），但随着翻译系统的复杂化，这种物理关联被"固化"后又被"重编程"，最终形成了现代的标准密码。
- 组成型遗传（模拟）和模板型遗传（数字）之间是否存在中间态？“少数派控制”模型提出，RNA最初可能是代谢网络中的稀有污染物，但因为其复制慢、不易稀释，反而成为系统的信息瓶颈。这种“少数派控制”可能是一种准数字状态：RNA序列不是代谢的蓝图，而是代谢的开关——存在或不存在某种RNA，决定了某个分支反应是否被激活。

> 铁这个元素，在生命起源、生理功能、物质丰度等方面，为何如此特殊，根本原因是什么？

铁的特殊性可以归结为几个“甜点”的叠加：

- **核物理甜点**：铁在宇宙中的高丰度源于一个物理事实：铁-56拥有所有原子核中最高的核子平均结合能。恒星通过核聚变释放能量，从轻元素一路燃烧到铁。当核心聚变产物达到铁时，进一步聚变不再释放能量，反而需要输入能量。因此铁成为恒星核合成的自然终点。大质量恒星最终通过超新星爆发将大量铁抛洒到星际空间，成为行星和生命形成的物质基础。换句话说，铁是宇宙炼金术能免费制造的最重元素之一。比铁重的元素（如铜、锌、钼）需要中子捕获等稀有过程才能生成，丰度断崖式下降。
- **地球化学甜点**：早期地球厌氧、富硫、富铁的环境恰好利于Fe-S化学。最早的生物催化可能不是蛋白质发明的，而是直接借用了地质化学的现成模块。Fe-S化学为生命提供了一个彩排平台。
- **配位化学甜点**：铁可以与硫、氧、氮等多种配体配位，形成从四面体到八面体的多种几何构型。特别是与硫的亲和力，使铁能在厌氧环境中形成稳定的Fe-S簇。
- **能量窗口甜点**：Fe²⁺/Fe³⁺之间的转换只需要转移一个电子，且电位适中（+0.77V左右），恰好落在生物氧化还原反应的常见能量窗口内。这让铁成为电子传递的理想介质。
- **结构模块甜点**：生物Fe-S簇都是离散的原子簇而非大晶体，这些簇是离散、可转移、可嵌入蛋白质的“催化芯片”，具有氧化还原活性和Lewis酸催化能力，能参与电子转移、底物结合和自由基反应。线粒体之所以被真核细胞保留，其根本目的可能就是为了维持Fe-S簇的合成。Fe-S簇的组装对真核细胞生存至关重要，而相关机器（ISC系统）起源于α-变形菌的内共生。

相比之下：

- **铜**虽然也有可变价态，但宇宙丰度远低于铁，且早期地球以还原态为主，铜主要以不溶的 Cu⁺ 形式存在
- **锌**主要是 Lewis 酸，缺乏氧化还原活性
- **锰**的氧化态变化涉及多电子转移，动力学上不够灵活
- **钼**丰度太低，且需要复杂的辅因子

总结：铁的特殊性，根本原因在于它是宇宙核合成能免费大量生产的、具有最灵活氧化还原化学的过渡金属。原始地球的化学环境（厌氧、碱性、富硫）恰好让铁能以 Fe-S 簇的形式自发组装出催化模块，而这些模块又恰好能驱动核心代谢反应（CO₂固定、电子传递）。生命不是“选择”了铁，而是在铁所开辟的通道中涌现出来。铁既是宇宙的灰烬，也是生命的火种。
